...
Partial Class PHTRZ
    ...
    Private Sub InitializeComponent()
        ...
        Me.TxtLoad.SLFIsSearchBox = False
        Me.TxtLoad.SLFJenisKapital = CMCv.ControlCodeBase.enuJenisKapital.Normal
        Me.TxtLoad.SLFPilihSemuaSaatFokus = False
        Me.TxtLoad.SLFPwdLengthMin = 8
        Me.TxtLoad.SLFPwdStrengthCalculate = False
        Me.TxtLoad.SLFPwdStrengthScore = 0
        Me.TxtLoad.SLFPwdStrengthText = Nothing
        Me.TxtLoad.SLFRestriction = CMCv.ControlCodeBase.enuRestriction.None
        Me.TxtLoad.SLFSearchBoxText = "Type then press Enter"
        ...
        Me.TxtSave.SLFIsSearchBox = False
        Me.TxtSave.SLFJenisKapital = CMCv.ControlCodeBase.enuJenisKapital.Normal
        Me.TxtSave.SLFPilihSemuaSaatFokus = False
        Me.TxtSave.SLFPwdLengthMin = 8
        Me.TxtSave.SLFPwdStrengthCalculate = False
        Me.TxtSave.SLFPwdStrengthScore = 0
        Me.TxtSave.SLFPwdStrengthText = Nothing
        Me.TxtSave.SLFRestriction = CMCv.ControlCodeBase.enuRestriction.None
        Me.TxtSave.SLFSearchBoxText = "Type then press Enter"
