...
#Region "Variables"
    ...
    Public clsIMGcompres As New CMCv.ImageEditor.Proccessor.Compress
    Public clsIMGeditor As New CMCv.ImageEditor.Proccessor.Editor
    Public varUSRaccess As New Application.Access
