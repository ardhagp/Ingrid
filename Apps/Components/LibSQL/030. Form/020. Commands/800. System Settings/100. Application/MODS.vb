...
Namespace Commands.MODS
    ...
    Public Class Editor
        ...
        Public Function PUSHData(ByVal ID As String, ByVal GroupID As String, ByVal Code As String, ByVal Name As String, ByVal Description As String, ByVal IsSystem As Boolean, ByVal IsLocked As Boolean, Optional ByVal RowID As String = "") As Boolean
            ...
            Try
                If RowID = "-1" Then
                    _DBR_MSSQL2008(1).Query = String.Format("insert into dbo.[[sys]]module](module_id, module_modulegroup, module_code, module_name, module_description, module_issystem, module_ismaintenance) " &
                                                            "values ('{0}','{1}','{2}','{3}','{4}','{5}','{6}')", ID, GroupID, Code, Name, Description, IsSystem, IsLocked)
                Else
                    _DBR_MSSQL2008(1).Query = String.Format("update dbo.[[sys]]module] set module_modulegroup = '{0}', module_name = '{1}', module_description = '{2}', module_issystem = '{3}', module_ismaintenance = '{4}' " &
