...
Namespace Commands.ACBK
    Public Class View
        ...
        Public Sub DisplayData(ByVal Datagrid As dgn, ByVal StatusBar As stt, ByVal Find As txt, Optional ByVal ForceRefresh As Boolean = False)
            ...
            _DBR_MSSQL2008(0).Query = String.Format("select ab.book_id, c.company_code, ab.book_code, ab.book_bookname, ab.book_datecreated from dbo.[[ac]]book] ab inner join dbo.[[man]]company] c on " &
