...
Namespace Commands.DAR
    Public Class View
        ...
        Public Function CheckSettings(ByVal UID As String, ByVal Attribute As String) As Boolean
            ...
            For _Row = 0 To 0
                _DBR_MSSQL2008(0).Query = String.Format("select count(mods.modulesettings_id) from dbo.[[sys]]modulesettings] mods inner join " &
            ...
            _DBR_MSSQL2008(0).Query = String.Format("select mods.modulesettings_value from dbo.[[sys]]modulesettings] mods inner join dbo.[[sys]]module] " &
        ...
        Public Function SaveSettings(ByVal UID As String, ByVal Attribute As String, ByVal Values As String) As Boolean
            ...
            Try
                _DBR_MSSQL2008(1).Query = String.Format("update dbo.[[sys]]modulesettings] set modulesettings_value = '{0}' where (modulesettings_module = " &
        ...
        Public Sub DisplayMainGrid(ByVal Find As txt, ByVal DateGrid As dgn, ByVal DateStatusBar As stt, ContentStatusBar As stt, ByVal chkDateFilter As chk, ByVal dtpDateFilter As dtp, ByVal chkByFilter As chk, ByVal cboByFilter As cbo, Optional ByVal ForceRefresh As Boolean = False)
            Try
                ...
                If (Find.SLFSQLText = String.Empty) AndAlso (ForceRefresh) Then
                    If Not (chkDateFilter.Checked) Then
                        _Where += String.Format("(year(ea.employeeactivity_datetime) = year(getdate())) And (month(ea.employeeactivity_datetime) = " &
                                                "month(getdate()))")
                    Else
                    ...
                    End If
                Else
                    If Not (Find.SLFSQLText.Trim.Contains("||")) Then
                ...
                _DBR_MSSQL2008(0).Query = String.Format("select ea.employeeactivity_datetime, (convert(varchar,ea.employeeactivity_datetime,106) + '' + " &
                                                        ...
                                                        "order by ea.employeeactivity_datetime desc", _Where)
        ...
        Public Sub DisplaySecondGrid(ByVal DateGrid As String, ByVal ContentGrid As dgn, ByVal ContentStatusBar As stt, ByVal Find As txt, Optional ByVal ShowAttachment As Boolean = False, Optional ByVal PhotoGrid As dgn = Nothing, Optional ByVal FileGrid As dgn = Nothing)
            Try
                ...
                _TimeFormat(1) = String.Format("(cast(ea.employeeactivity_time as varchar(8)) + ' - ' + cast(ea.employeeactivity_time_end as varchar(8))) " &
                                               "as [employeeactivity_time]")

                'same day with time range format & different day format
                _TimeFormat(2) = String.Format("(case when ((ea.employeeactivity_datetime_end = ea.employeeactivity_datetime) And " &
                ...
                Dim _Description As String = "case when (ea.employeeactivity_feedback is null) or (convert(varchar(max),ea.employeeactivity_feedback) = '') " &
                ...
                _DBR_MSSQL2008(2).Query = String.Format("select aa.areaaffected_name, {1}, {2}, case when (ea.employeeactivity_lastupdate is not null) and " &
                                                        ...
                                                        "aa.areaaffected_order, ea.employeeactivity_time", _Where, _TimeFormat(2), _Description)
        ...
        Public Sub DisplayPhotoGrid(ByVal ContentID As String, ByVal FileGrid As dgn, Optional ByVal RecordYear As String = "")
            ...
            _DBR_MSSQL2008(4).Query = String.Format("select fi.file_id, fi.file_content, (convert(varchar(25),fi.file_content_size) + ' KB') " &
                                                    ...
                                                    "and fi.file_filetype = 'jpg') order by fi.file_score desc, fi.file_datetime;", _CONTENTID)
        ...
        Public Sub DisplayFileGrid(ByVal ContentID As String, ByVal FileGrid As dgn, Optional ByVal RecordYear As String = "")
            ...
            _DBR_MSSQL2008(5).Query = String.Format("select fi.file_id, fi.file_tag, '' as [file_content], " &
                                                    ...
                                                    "fi.file_filetype = 'pdf') order by fi.file_datetime;", _CONTENTID)
    ...
    Public Class Editor
        ...
        Public Sub GETRowValue(ByVal RowID As String, ByVal DatePart As CMCv.dtp, ByVal TimePart As CMCv.meb, ByVal DatePartEnd As CMCv.dtp, ByVal TimePartEnd As CMCv.meb, ByVal ListOfAffectedArea As cbo, ByVal ListOfTemplate As cbo, ByVal TemplateContent As CMCv.txt, ByVal FeedBack As CMCv.txt)
            ...
            _DBR_MSSQL2008(1).Query = String.Format("select ea.employeeactivity_template from dbo.[[doc]]employeeactivity] ea " &
                                                    "where ea.employeeactivity_id = '{0}'", RowID)
            ListOfTemplate.SelectedValue = _DBE_MSSQL2008.GETVALUE(_DBR_MSSQL2008(1).Query)

            _DBR_MSSQL2008(1).Query = String.Format("select ea.employeeactivity_description from dbo.[[doc]]employeeactivity] ea " &
                                                    "where ea.employeeactivity_id = '{0}'", RowID)
            TemplateContent.Text = _DBE_MSSQL2008.GETVALUE(_DBR_MSSQL2008(1).Query)

            Dim _Feedback As Object = Nothing
            _DBR_MSSQL2008(1).Query = String.Format("select ea.employeeactivity_feedback from dbo.[[doc]]employeeactivity] ea " &
                                                    "where ea.employeeactivity_id = '{0}'", RowID)
        ...
        Public Function DisplayPhotoGrid(ByVal RowID As String, ByVal FileGrid As dgn) As DataSet
            _DS = New DataSet
            'ReDim _DBR_MSSQL2008(3)
            _DBR_MSSQL2008(2).Query = String.Format("select fi.file_id, fi.file_content, fi.file_datetime, fi.file_uploader " &
        ...
        Public Function DisplayFileGrid(ByVal RowID As String, ByVal FileGrid As dgn) As DataSet
            _DS = New DataSet
            'ReDim _DBR_MSSQL2008(3)
            _DBR_MSSQL2008(2).Query = String.Format("select fi.file_id, fi.file_tag, fi.file_content, fi.file_datetime, fi.file_uploader " &
                                                    "from db_universe_erp_file.dbo.[[sto]]file] fi where (fi.file_parent = '{0}' and " &
        ...
        Public Function PUSHData(ByVal AreaAffected As String, ByVal ActivityTemplate As String, ByVal DatePart As String, ByVal TimePart As String, ByVal DatePartEnd As String, ByVal TimePartEnd As String, ByVal Content As String, ByVal Feedback As String, ByVal UserID As String, ByVal RowID As String, ByVal IsNew As Boolean, Optional ExtendedQuery As String = "")
            ...
            Try
                If (IsNew) Then
                    _DBR_MSSQL2008(1).Query = String.Format("insert into dbo.[[doc]]employeeactivity](employeeactivity_id, employeeactivity_areaaffected, " &
                ...
                Else
                    _DBR_MSSQL2008(1).Query = String.Format("update dbo.[[doc]]employeeactivity] set employeeactivity_datetime = '{0}', " &
                    ...
                    _DBR_MSSQL2008(1).Query += String.Format("update db_universe_erp_file.dbo.[[sto]]file] set file_parentdate = '{0}' " &
    ...
    Public Class Reports
        Public Sub Display(ByVal ChkFrom As chk, ByVal ChkTo As chk, ByVal ChkArea As chk, ByVal ChkActivity As chk, ByVal ChkBy As chk, ByVal DTPFrom As dtp, ByVal DTPTo As dtp, ByVal CboArea As cbo, ByVal CboActivity As cbo, ByVal CboBy As cbo, ByVal TxtDescription As txt, ByVal DataSetName As DataSet)
            ...
            Try
                ...
                If TxtDescription.SLFSQLText.Trim <> String.Empty Then
                    ...
                    'multiple keywords execution
                    If Not (TxtDescription.SLFSQLText.Trim.Contains("||")) Then
                ...
                'same day with different time
                _TimeFormat(1) = String.Format("(cast(ea.employeeactivity_time as varchar(8)) + ' - ' + " &
                ...
                Dim _Description As String = "case when (ea.employeeactivity_feedback is null) or " &
                ...
                _DBR_MSSQL2008(0).Query = String.Format("select aa.areaaffected_name, {1}, {2}, case when (ea.employeeactivity_lastupdate is not null) " &
                                                        ...
                                                        "order by aa.areaaffected_order", _Where, _TimeFormat(2), _Description)
