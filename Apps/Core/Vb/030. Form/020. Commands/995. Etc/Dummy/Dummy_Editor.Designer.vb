...
Partial Class Dummy_Editor
    ...
    Private Sub InitializeComponent()
        ...
        Btn1.SLFJenisTombol = CMCv.ControlCodeBase.enuJenisTombol.Default
        Btn1.SLFTampilkanFocusBorder = False
        Btn1.SLFValidasiSemuaInput = False
        Btn1.SLFValidasiSemuaInputTag = Nothing
        Btn1.TabIndex = 1
        Btn1.Text = "Btn1"
        ...
        Btn2.SLFJenisTombol = CMCv.ControlCodeBase.enuJenisTombol.Default
        Btn2.SLFTampilkanFocusBorder = False
        Btn2.SLFValidasiSemuaInput = False
        Btn2.SLFValidasiSemuaInputTag = Nothing
        Btn2.TabIndex = 2
        Btn2.Text = "Btn2"
