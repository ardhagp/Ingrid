...
Partial Class frmDialogBox
    ...
    Private Sub InitializeComponent()
        ...
        Me.TxtMessage.SLFIsSearchBox = False
        Me.TxtMessage.SLFJenisKapital = CMCv.ControlCodeBase.enuJenisKapital.Normal
        Me.TxtMessage.SLFPilihSemuaSaatFokus = False
        Me.TxtMessage.SLFPwdLengthMin = 8
        Me.TxtMessage.SLFPwdStrengthCalculate = False
        Me.TxtMessage.SLFPwdStrengthScore = 0
        Me.TxtMessage.SLFPwdStrengthText = Nothing
        Me.TxtMessage.SLFRestriction = CMCv.ControlCodeBase.enuRestriction.None
        Me.TxtMessage.SLFSearchBoxText = "Type then press Enter"
