...
Public Class Workspace
    ...
    Public Shared Function GETModuleName(ByVal TCode As String)
        ...
        Try
            ...
            _Value = V_DBE_MSSQL2008.GETVALUE(V_DBR_MSSQL2008(1).Query)
    ...
    <SupportedOSPlatform("windows")>
    Public Shared Function GETModuleDescription(ByVal TCode As String)
        Dim _Value As String
