...
Namespace Commands.CDIN
    Public Class View
        ...
        Public Sub DisplayData(ByVal DataGrid As dgn, ByVal StatusBar As stt, ByVal Find As txt, Optional ByVal ForceRefresh As Boolean = False)
            ...
            _DBR_MSSQL2008(0).Query = String.Format("select d.departement_id, c.company_code, d.departement_code, d.departement_name, d.departement_description from dbo.[[man]]departement] d inner join dbo.[[man]]company] c " &
    ...
    Public Class Editor
        ...
        Public Function PUSHData(ByVal Company As String, ByVal DepartementCode As String, ByVal DepartementName As String, ByVal DepartementDescription As String, Optional ByVal RowID As String = "-1") As Boolean
            ...
            Try
                ...
                Else
                    _DBR_MSSQL2008(1).Query = String.Format("update dbo.[[man]]departement] set departement_company = '{0}', departement_code = '{1}', departement_name = '{2}', departement_description = '{3}' " &
