...
Namespace Commands.MCTG
    Public Class View
        Public Sub DisplayData(ByVal Datagrid As dgn, ByVal StatusBar As stt, ByVal Find As txt, Optional ByVal ForceRefresh As Boolean = False)
            ...
            Else
                _DBR_MSSQL2008(0).Query = String.Format("select m.material_id, m.material_number, m.material_name, m.material_longtext, mg.materialgroup_code, mt.materialtype_code, m.material_isidentifier, " &
                                                        ...
                                                        "(m.material_longtext like '%{0}%') order by m.material_number;", Find.SLFSQLText)
            End If
